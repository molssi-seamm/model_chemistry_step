...
Installation
============
The Model Chemistry step is probably already installed in your SEAMM
...
check for `model-chemistry-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update model-chemistry-step
