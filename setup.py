...
setup(
    ...
    url='https://github.com/molssi-seamm/model_chemistry_step',
    ...
    packages=find_packages(include=['model_chemistry_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Model Chemistry = model_chemistry_step:ModelChemistryStep',
        ],
        'org.molssi.seamm.tk': [
            'Model Chemistry = model_chemistry_step:ModelChemistryStep',
        ],
