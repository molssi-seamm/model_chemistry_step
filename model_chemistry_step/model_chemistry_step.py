...
class ModelChemistryStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Model Chemistry step. It must be
    ...
    my_description = {
        "description": "An interface for Model Chemistry",
        "group": "Simulations",
        "name": "Model Chemistry",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return model_chemistry_step.ModelChemistry(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return model_chemistry_step.TkModelChemistry(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return ModelChemistryStep.my_description
