...
class ModelChemistryParameters(seamm.Parameters):
    """
    ...
    def __init__(self, defaults={}, data=None):
        ...
        logger.debug("ModelChemistryParameters.__init__")

        super().__init__(
            defaults={**ModelChemistryParameters.parameters, **defaults}, data=data
        )
