...
do
	...
	sphinx-apidoc -o docs/developer model_chemistry_step
...
<html>
   <head>
      <title>Documentation for the Model Chemistry plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Model Chemistry plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
